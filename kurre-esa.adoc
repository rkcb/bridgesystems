...
- ehdotuksia 1NT-häirintään, jossa Lebensohl ja siirtoja
- reversen jälkeen Lebensohl
- vastustajan kahdennuksen jälkeen myös Lebensohl
- 1NT- ja 2NT-jatkot täydennetty

== Pöytäkortti

=== Avaukset

[%header, cols="1,1", frame=none, grid=none]
|===
|Avaus | Vastaus

| 1&clubs; = 2+&clubs;, 11+
| 1 [red]#&diams;# = 4+ [red]#&hearts;#  , 6+ (vaikka x välissä) +
1 [red]#&hearts;#  = 4+&spades;   , 6+ (vaikka x välissä) +
1&spades;    = 4+ [red]#&diams;#  , 6+ (vaikka x välissä) +
1NT = tas, ei 4yv, 6-10p, +
2&clubs;  = 5+&clubs; , yleensä tasaisehko, ei 4yv, 5-10p, +
3&clubs;  = 5+&clubs; , yleensä epätas., ei 4yv, 11-12p, +

|1 [red]#&diams;# = 4+ [red]#&diams;#, 11+

| 1 [red]#&hearts;# = 4+ [red]#&hearts;#, 6+ +
1&spades; = 4+&spades;, 6+ +
1NT = 6-10, ei 4yv, +
 2 [red]#&diams;#  = 6-10 +

| 1 [red]#&hearts;# = 5+ [red]#&hearts;#, 11+
| 2NT = Jacoby 2NT, 4+ [red]#&hearts;#, tpv +

| 1 &spades; = 5+&spades;, 11+
| 2NT = Jacoby 2NT, 4+ &spades;, tpv +

| 1NT = 15-17, tasainen, 5yv mahdollinen, joskus tasaisehko
| 2&clubs; = Stayman +
  2 [red]#&diams;# = siirto, 5+ [red]#&hearts;# , 0+ +
  2 [red]#&hearts;#  = siirto, 5+&spades;, 0+ +
  2&spades; = siirto, 6+&clubs; +
  2NT = inviitti, 8-9 +


| 2&clubs; = 22+
| 2 [red]#&diams;# = odottava +
uusi väri = 5k tarjottu väri, 8+

| 2 [red]#&diams;#, 2 [red]#&hearts;#, 2&spades; = 6k tarjottu väri, 6-10
| 2NT kysyy lyhyyttä, värin toisto => ei ole

| 3+ väri = luonnollinen estotarjous
|

|===

=== Lähdöt, merkinannot ja ässäkysely

==== Lähtöjen tyyli

[%header, cols="1,1,2"]
|===
| | Lähtö | Partnerin värissä
...
3+| Muuten: *tukemattomassa partnerin värissä lähdetään: 1/3/5, [.underline]##x##x, xx[.underline]##x##, jne.

3+| NT-sopimusta vastaan kuningas on vahva lähtö, pyytää joko rouvan ablokeerausta tai pituusmerkinantoa.

|===

==== Lähtökombinaatioista

[cols="1,2,2"]
|===
| Lähtö | Väriä vastaan | NT:tä vastaan
...
| 9
| H9x, T9+
| Melko sama, (ehkä J98x)

| Hakku
| H[.underline]##x##x, Hxx[.underline]##x##x(\+), x[.underline]##x##x+
| Sama

| Hakku
| x[.underline]##x##, Hxx[.underline]##x##
| Melko sama (ehkä Txx[.underline]##x##)
|===


Lähdön jälkeen jatketaan ilman poikkeavaa syytä lähtökorttisäännön mukaan pelin edetessä.

==== Merkinannot

Merkinannot: pieni pyytää tai parillinen, Lavinthal

==== Ässäkysely

Ässäkysely: RKCB 14/03
...
include::conventions/lebensohl-after-reverse.adoc[]
...
include::conventions/1nt.adoc[]

== 2NT-jatkot

include::conventions/2nt.adoc[]

== 2 &clubs;  - jatkot

include::conventions/2c.adoc[]
...
include::conventions/lebensohl-transfers.adoc[]
...
=== Vastustajan heikko kakkonen ja kahdentaminen

include::conventions/weak2-double-responses.adoc[]