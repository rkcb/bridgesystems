...
vastaavasti. Kun 2NT-tarjouksen jälkeen halutaan vähintään
inviittivoimalla tarjota oma 5k väri tai näyttää tuki partnerille,
niin käytämme alempaa vastustajan tarjoamaa väriä tarjoamaan jäljelle jäävistä
väreistä alempaa ja vastustajan ylempää väriä vastaavasti ylempään.
Esimerkki. Sarjassa 1 &clubs; - (2NT) em. jäljelle jäävät värit eli
risti ja pata tarjotaan vastaavasti ruudulla ja hertalla.
...
|
| 2NT = unusual 2NT
| Dbl = 11+, pidot vast. väreissä +
3 &clubs; = 4+ [red]#&#9670;# , 11+ +
3 [red]#&#9670;# = 4+ [red]#&#9670;#,  7-10 +
3 [red]#&hearts;# = 5+ &spades; , 11+ +
3NT = pelattavaksi, 13-16 +
4 &clubs;, 4 [red]#&hearts;# = 0-1 värissä ja 4+ [red]#&#9670;# , slammitriali
...
Gerber on voimassa vain seuraavissa tilanteissa:

- 1NT - 4 &clubs; (missä 1NT voi myös olla välitarjous)
- 2NT - 4 &clubs;
- 1x - 1y; 2NT - 4 &clubs;, missä x ja y ovat värejä
- 2 &clubs; - 2x; 2NT - 4 &clubs;, missä x ja y ovat värejä
- 2 &clubs; - 2NT; 4 &clubs;

Alla Gerber-vastaukset.

|===
|Kysyjä | Vastaaja | Kysyjän 2. | Vastaajan 2. | Kysyjän 3.

| 4 &clubs; = kysyy ässien lkm
| 4 [red]#&#9670;# = 0 / 4 +
4 [red]#&hearts;# = 1 +
4 &spades; = 2 +
4NT = 3
